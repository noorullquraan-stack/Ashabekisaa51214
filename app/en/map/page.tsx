  ...
  return (
    <div className="w-full bg-black relative flex-1 flex flex-col justify-between [perspective:1500px] p-4 md:p-5 overflow-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto px-4 pt-8 pb-4">
        <h2 className="text-center text-[#D4AF37] text-lg md:text-xl font-bold font-serif mb-3">
          Learn about Markaz-e Ashab-e Kisaa (A.S)
        </h2>
        <div className="relative w-full aspect-video rounded-xl overflow-hidden border border-[#D4AF37]/30 shadow-[0_0_30px_rgba(212,175,55,0.2)]">
          <video
            src="https://res.cloudinary.com/dmqej8n4z/video/upload/v1782393097/Ashabal-Kisaa-ezgif.com-gif-maker_i6xavx.webm"
            controls
