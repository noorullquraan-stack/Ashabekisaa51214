...
export default function ZiyaratEn() {
  const liveZiyarat = {
    title: "Live Ziyarat of the Holy Shrine of Imam Hussain (AS)",
    desc: "Open the live broadcast of the holy shrine and stay connected to the spiritual atmosphere of Karbala from anywhere.",
    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500 selection:text-white font-sans">
      <main className="flex-1 p-6 md:p-12 lg:px-32 bg-gradient-to-b from-[#0a0a0a] via-black to-[#050505]" dir="ltr">
        <div className="relative mb-14 text-left">
          ...
          <span className="inline-block text-emerald-400 text-[9px] font-bold tracking-[0.2em] bg-emerald-400/10 px-4 py-1.5 rounded-full border border-emerald-400/20 mb-5 uppercase">Live Ziyarat</span>
          <h1 className="text-3xl md:text-5xl font-black mb-5 tracking-tight leading-tight italic">Holy <span className="bg-gradient-to-r from-emerald-400 to-yellow-500 bg-clip-text text-transparent">Ziyarat</span></h1>
          <p className="text-zinc-500 text-sm md:text-base max-w-2xl font-light">Live broadcast from the holy shrine of Imam Hussain (AS) in Karbala.</p>
        </div>

        <section className="relative mb-12 overflow-hidden rounded-[1.75rem] border border-emerald-400/20 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.14),transparent_35%),linear-gradient(135deg,rgba(9,9,11,0.96),rgba(17,24,39,0.92))] p-5 md:p-8 shadow-[0_0_40px_rgba(16,185,129,0.08)]">
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="https://imamhussain.org/english/live"
                target="_blank"
