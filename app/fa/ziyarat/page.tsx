...
export default function ZiyaratFa() {
  const liveZiyarat = {
    title: "پخش زنده و زیارت حرم مطهر امام حسین (علیه السلام)",
    desc: "زیارت زنده حرم مطهر را مستقیم مشاهده کنید و در هر لحظه با فضای معنوی کربلای معلی همراه باشید.",
    ...
    <div className="min-h-screen bg-black text-white selection:bg-emerald-500 selection:text-white font-sans">
      <main className="flex-1 p-6 md:p-12 lg:px-32 bg-gradient-to-b from-[#0a0a0a] via-black to-[#050505]" dir="rtl">
        <div className="relative mb-14 text-right">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-5 tracking-tight leading-tight italic">زیارات <span className="bg-gradient-to-r from-emerald-400 to-yellow-500 bg-clip-text text-transparent">مبارک</span></h1>
          <p className="text-zinc-500 text-sm md:text-base max-w-2xl font-light leading-relaxed text-right">پخش مستقیم زنده از حرم مطهر امام حسین (علیه السلام) در کربلای معلی.</p>
        </div>
        ...
        <section className="relative mb-12 overflow-hidden rounded-[1.75rem] border border-emerald-400/20 bg-[radial-gradient(circle_at_top_right,rgba(16,185,129,0.14),transparent_35%),linear-gradient(135deg,rgba(9,9,11,0.96),rgba(17,24,39,0.92))] p-5 md:p-8 shadow-[0_0_40px_rgba(16,185,129,0.08)]">
          ...
          <div className="relative space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              <a
                href="https://imamhussain.org/persian/live"
                target="_blank"
