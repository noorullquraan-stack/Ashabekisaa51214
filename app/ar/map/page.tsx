...
// 🎯 یہ ڈیفالٹ ایکسپورٹ ہونا لازمی ہے تاکہ ورسل کا ایرر ختم ہو
export default function ArabicMapPage() {
    ...
    return (
        <div className="w-full min-h-screen bg-black relative flex flex-col justify-between [perspective:1500px] p-4 md:p-5">
            {/* 🗺️ الخريطة المركزية */}
