    ...
    return (
        <div className="flex items-center gap-1.5">
            {socialLinks.map((social) => (
                <a key={social.name} href={social.url} target="_blank" rel="noopener noreferrer" className="w-6.5 h-6.5 rounded-md bg-zinc-900/60 border border-[#D4AF37]/10 flex items-center justify-center text-[#D4AF37]/70 hover:text-[#D4AF37] hover:border-[#D4AF37] hover:bg-[#D4AF37]/10 shadow-md">
