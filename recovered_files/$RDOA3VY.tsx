...
const countries: Country[] = [
  {
    ...
    height: 95,
    details:
      "جزائر پر مشتمل چھوٹے ملک گنی بساؤ میں مرکز اصحاب الکساء نے غریب ماہی گیروں اور پسماندہ خاندانوں کے لیے معاشی خودمختاری کے چھوٹے پراجیکٹس متعارف کروائے ہیں، جس سے مقامی روزگار میں واضح بہتری دیکھنے کو مل رہی ہے۔",
  },
  {
    slug: "cote-divoire",
    name: "آئیوری کوسٹ",
    ...
    height: 130,
    details:
      "آئیوری کوسٹ کے شہری اور دہی خطوں میں علمی و فلاحی خدمات کے تحت اسکولوں کی تعمیر نو کی گئی ہے۔ مرکز یہاں اساتذہ کی تربیت اور جدید تعلیمی نصاب کی فراہمی کو یقینی بنا رہا ہے تاکہ نسلِ نو کی فکری اور اخلاقی نشوونما بہتر ہو سکے۔",
  },
  {
    slug: "burkina-faso",
    name: "برکینا فاسو",
    ...
    height: 110,
    details:
      "برکینا فاسو میں مرکز نے اپنی اعلیٰ اخلاقی اور علمی روایات کے مطابق یتیم بچوں کی کفالت کا ایک مستقل پروگرام شروع کیا ہے۔ ان بچوں کو اعلیٰ تعلیم کے ساتھ ساتھ رہائش اور خوراک کا مکمل تحفظ دیا جا رہا ہے تاکہ وہ معاشرے کے مفید شہری بن سکیں۔",
  },
  {
    slug: "niger",
    name: "نائجر",
    ...
    height: 160,
    details:
      "مرکز اصحاب الکساء کے تحت نائجر کے پسماندہ خطوں میں خالص علمی نیٹ ورک اور فلاحی منصوبوں کا آغاز کیا گیا ہے۔ یہاں مقامی آبادی کے لیے پینے کے صاف پانی کے کنویں اور بنیادی تعلیمی مراکز قائم کیے جا رہے ہیں تاکہ صحرائی زندگی میں ایک مثبت تبدیلی لائی جا سکے۔",
  },
  {
    slug: "nigeria",
    name: "نائجیریا",
    ...
    height: 150,
    details:
      "نائجیریا میں مرکز کی خدمات کا دائرہ کار انتہائی وسیع ہے۔ یہاں نوجوانوں کو ہنر مند بنانے کے لیے تکنیکی تعلیمی ادارے اور مستحق خاندانوں کے لیے راشن کی باقاعدہ فراہمی کا فلاحی نظام کامیابی سے چل رہا ہے۔",
  },
  {
    slug: "cameroon",
    name: "کیمرون",
    ...
    height: 135,
    details:
      "کیمرون کے ساحلی اور پہاڑی علاقوں میں مرکز کے فلاحی نیٹ ورک نے دور دراز کے قبیلوں تک رسائی حاصل کی ہے۔ یہاں بنیادی صحت کے مراکز کا قیام عمل میں لایا گیا ہے، جہاں بچوں اور ماؤں کو مفت طبی سہولیات فراہم کی جاتی ہیں۔",
  },
  {
    slug: "tanzania",
    name: "تنزانیہ",
    ...
    height: 150,
    details:
      "مشرقی افریقہ کے اہم ملک تنزانیہ میں مرکز اصحاب الکساء کی علمی تحریک عروج پر ہے۔ یہاں جدید لائبریریوں کا قیام، اسکالرشپ پروگرامز، اور صحت کے شعبے میں فری میڈیکل کیمپس کے ذریعے ہزاروں خاندانوں کو مفت علاج اور ادویات پہنچائی جا رہی ہیں۔",
  },
];
      ...
      {activeCountry && (
        ...
        >
          ...
          >
            ...
            <h3 className="mb-4 border-b border-zinc-800 pb-3 text-center text-2xl font-bold text-amber-400 font-serif md:text-3xl">
              {activeCountry.name}
            </h3>
